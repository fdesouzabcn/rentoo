...
class Property extends Model
{
    ...
    // Defines many-to-one relationship: Many Properties → One Owner
    public function owner(): BelongsTo
    {
        return $this->belongsTo(Owner::class);
    }

    // Defines one-to-many relationship: One Property → Many Contracts
    public function contracts(): HasMany
    {
        return $this->hasMany(Contract::class);
    }

    //Automatically uppercase: cadastral_reference / energy_certificate_number / habitability_certificate_number
