...
class Contract extends Model
{
    ...
    // Defines many-to-one relationship: Many Contracts → One Property
    public function property(): BelongsTo
    {
        return $this->belongsTo(Property::class);
    }

    // Ensures consistency(uppercase) for DNIs regardless of input format.
    ...
    // Method to check if contract is in DRAFT / ACTIVE / FINALIZED status
