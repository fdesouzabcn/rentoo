...
@section('title', 'Crear Nueva Propiedad - Rentoo')
...
@section('content')
    ...
    {{-- Page Header --}}
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-slate-900">Crear Nueva Propiedad</h1>
        <p class="text-slate-600 mt-1">Complete el formulario para registrar una nueva propiedad</p>
    </div>
                ...
                <div>
                    ...
                    <select id="owner_id"
                        ...
                        @foreach($owners as $owner)
                            <option value="{{ $owner->id }}"
                                    {{ old('owner_id', $selectedOwnerId) == $owner->id ? 'selected' : '' }}>
                    ...
                    @if($owners->isEmpty())
                        <p class="mt-2 text-sm text-yellow-700 bg-yellow-50 border border-yellow-200 rounded p-3">
                            ...
                            <a href="{{ route('owners.create') }}" class="underline font-medium hover:text-yellow-900">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="md:col-span-3">
                        ...
                        <textarea id="description"
                                  ...
                                  placeholder="Descripción adicional de la propiedad...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select id="energy_certificate_rating"
                            ...
                            @foreach(['A', 'B', 'C', 'D', 'E', 'F', 'G'] as $rating)
                                <option value="{{ $rating }}" {{ old('energy_certificate_rating') == $rating ? 'selected' : '' }}>
                                    {{ $rating }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               value="{{ old('energy_certificate_number') }}"
                               required
                               maxlength="50"
                               pattern="[A-Z0-9]+"
                    ...
                    <div>
                        ...
                        <input type="date"
                               ...
                               value="{{ old('energy_certificate_expiry') }}"
                               required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               value="{{ old('habitability_certificate_number') }}"
                               required
                               maxlength="50"
                               pattern="[A-Z0-9]+"
                    ...
                    <div>
                        ...
                        <input type="date"
                               ...
                               value="{{ old('habitability_certificate_expiry') }}"
                               required
                               min="{{ date('Y-m-d', strtotime('+1 day')) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number"
                               ...
                               value="{{ old('community_fees_monthly') }}"
                               min="0"
                               max="999999.99"
                               step="0.01"
        ...
        <div class="flex items-start gap-3">
            ...
            <div class="text-sm text-blue-800">
                ...
                <ul class="list-disc list-inside space-y-1 text-blue-700">
                    <li>La referencia catastral debe tener exactamente 20 caracteres</li>
                    <li>Las fechas de vencimiento de certificados deben ser futuras</li>
                    <li>Los campos financieros son opcionales pero recomendables</li>
                </ul>
            </div>
        </div>
    </div>
